...
#### TC-AUTH-001 | Login com Usuário Padrão
...
#### TC-AUTH-002 | Login com Usuário Problem
...
#### TC-AUTH-003 | Login com Performance Glitch User
...
#### TC-AUTH-004 | Erro com Senha Inválida
...
#### TC-AUTH-005 | Erro com Usuário Inválido
...
#### TC-AUTH-006 | Erro com Campos Vazios
...
#### TC-AUTH-007 | Mascaramento de Senha (Nível 2)
...
#### TC-AUTH-008 | Acessibilidade - Labels (Nível 2)
...
#### TC-PROD-001 | Exibir Todos os Produtos
...
#### TC-PROD-002 | Ordenar Produtos A-Z
...
#### TC-PROD-003 | Ordenar Produtos Z-A
...
#### TC-PROD-004 | Ordenar por Preço Menor para Maior
...
#### TC-PROD-005 | Ordenar por Preço Maior para Menor
...
#### TC-PROD-006 | Adicionar Produto ao Carrinho
...
#### TC-PROD-007 | Remover Produto do Carrinho
...
#### TC-PROD-008 | Navegar para Carrinho
...
#### TC-PROD-009 | Validar Formato de Preços (Nível 2)
...
#### TC-PROD-010 | Adicionar Múltiplos Produtos (Nível 2)
...
#### TC-PROD-011 | Responsividade Mobile (Nível 2)
...
#### TC-PROD-012 | Validar Imagens de Produtos (Nível 2)
...
#### TC-CART-002 | Adicionar Item e Verificar no Carrinho
...
#### TC-CART-004 | Múltiplos Itens no Carrinho
...
#### TC-CART-005 | Remover Item Específico
...
#### TC-CART-006 | Prosseguir para Checkout
...
#### TC-CART-007 | Continuar Comprando
...
#### TC-CART-008 | Calcular Total (Nível 2)
...
#### TC-CART-009 | Persistência do Carrinho (Nível 2)
...
#### TC-CART-010 | Responsividade Mobile (Nível 2)
...
#### TC-CHECK-001 | Preencher Informações e Continuar
...
#### TC-CHECK-002 | Validar First Name Obrigatório
...
#### TC-CHECK-003 | Validar Last Name Obrigatório
...
#### TC-CHECK-004 | Validar Postal Code Obrigatório
...
#### TC-CHECK-005 | Completar Checkout com Sucesso
...
#### TC-CHECK-006 | Exibir Resumo do Pedido
...
#### TC-CHECK-007 | Cancelar Checkout
...
#### TC-CHECK-008 | Caracteres Especiais em Nomes (Nível 2)
...
#### TC-CHECK-009 | Validar Múltiplos Formatos de Postal Code (Nível 2)
